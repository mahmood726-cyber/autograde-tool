        # Autograde Tool: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/autograde-tool.git

        ## Objective

        AutoGRADE automates GRADE evidence certainty assessment for systematic reviews, translating heterogeneity, bias, and imprecision signals into structured certainty profiles.
        ...
        - Code: https://github.com/mahmood726-cyber/autograde-tool.git
        - Dashboard: https://mahmood726-cyber.github.io/autograde-tool/
